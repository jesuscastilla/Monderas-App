...
class WelcomeViewModel(app: Application) : AndroidViewModel(app) {
    ...
    var isConnecting by mutableStateOf(value = false)
        ...
        viewModelScope.launch {
            ...
            if (result.discovered > 0) {
                ...
                message = result.error?.takeIf { it.isNotBlank() }
                    ...
                    ?: "No se encontraron calendarios. Revisa tus credenciales o contacta con la organización."
            }
        }
    }
}
            ...
            OutlinedTextField(
                ...
                keyboardActions = KeyboardActions(
                    onDone = {
                        ...
                        if (user.isNotBlank() && pass.isNotBlank() && !vm.isConnecting) {
                            vm.connect(user, pass, insecureTls = false) { onConnected() }
                        }
                    }
                ),
                trailingIcon = {
